...
const SvgIconStackOverflow = (
  ...
  >
    ...
    <g clipPath="url(#icon-stack-overflow_svg__a)">
      <path
        fill="currentColor"
    ...
    <defs>
      <clipPath id="icon-stack-overflow_svg__a">
        <path fill="#fff" d="M0 .5h16v16H0z" />
      </clipPath>
    </defs>
  </svg>
);
const ForwardRef = forwardRef(SvgIconStackOverflow);
